...
{
    public partial class ManagerStationaryTrendByDept : System.Web.UI.Page
    {
        int cmp = 1;
        ...
        protected void btngenerate_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/ManagerStationaryTrendByDeptReport.aspx");
        }

        protected void btnCancel_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/ManagerStationaryTrendByDept.aspx");
        }
