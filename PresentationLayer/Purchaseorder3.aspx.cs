...
{
    public partial class Purchaseorder3 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // System.Diagnostics.Debug.WriteLine("itemcode = " + itms);
            //PurOrderGridView.DataSource = (string)(Session["field1"]);
            if (!IsPostBack)
            {
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (lblDate.Text == "")
                {
                    lblDateError.Text = "Please select delivery date";
                    lblError.Text = "Unsuccessful submit";
                    if (currentPO == maxPO)
                    {
